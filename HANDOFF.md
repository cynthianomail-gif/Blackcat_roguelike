...
| **M7 美術/UI 打磨**（滿版縮放/怪物程序動畫/粒子/字型/HUD/轉場/31 怪剪影精修/Boss 攻擊幀/key art） | ✅ 已部署 | `f1b62b4`…`7b57428`（13 commits） |
| **M8 有機剪影外框＋門重設計**（seed 輪廓烘焙/格線移除/貓耳拱門/光錐/荊棘鎖門） | ✅ 已部署（2026-06-12），視覺回饋待真人試玩 | `3bf2a1c`…`3d97fa2`（6 commits） |
